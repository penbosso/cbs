                        ...
                        <div className="px-4 py-5 bg-white sm:p-6">
                            ...
                            <Form
                                ...
                                initialValues={{
                                    ...
                                    total_number_of_places_available: marketRecord?.total_number_of_places_available,
                            ...
                            >
                                <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                                    <Col>
                                        ...
                                        <Form.Item
                                            label="No. available"
                                            name="total_number_of_places_available"
                                        ...
                                        <table class="table-auto border-collapse border border-gray-300">
                                            ...
                                            {records.map(record => {
                                                return (<tr> <td class="border border-gray-300 px-4 py-2">{record.component_name}</td>
                                                    <td class="border border-gray-300 px-4 py-2">{record.total_number_of_places_available}</td>
